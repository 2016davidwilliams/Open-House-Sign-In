...
form.addEventListener('submit',async(e)=>{
 ...
 const payload={full_name:text('#fullName'),address:text('#address')||null,email:email||null,phone:phone||null,working_with_agent:document.querySelector('input[name="agent"]:checked')?.value||null,current_needs:selectedNeeds(),notes:text('#notes')||null,source:'website',consent_to_contact:true,user_agent:navigator.userAgent};
